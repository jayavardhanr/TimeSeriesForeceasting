...
# i=0
# while i+406<=60000:
#     testDataSequences_Input.append(v5[i:i+208])
#     i+=208
#     testDataSequences_Output.append(v5[i:i+208])
#     
# i+=208
# while i+406<=225000:
#     trainDataSequences_Input.append(v5[i:i+208])
#     i+=208
#     trainDataSequences_Output.append(v5[i:i+208])
# 
# print(i)
# =============================================================================
...
i=0
while i+832<=60000:
    testDataSequences_Input.append(v5[i:i+416])
    testDataSequences_Output.append(v5[i+416:i+832])
    i+=208
    
    
i+=208+416
while i+832<=225000:
    trainDataSequences_Input.append(v5[i:i+416])
    trainDataSequences_Output.append(v5[i+416:i+832])
    i+=208
...
# =============================================================================
# np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_trainDataInput_208.npy',trainDataArray_Input)
# np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_trainDataOutput_208.npy',trainDataArray_Output)
# np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_testDataInput_208.npy',testDataArray_Input)
# np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_testDataOutput_208.npy',testDataArray_Output)
# =============================================================================

np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_trainDataInput_416.npy',trainDataArray_Input)
np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_trainDataOutput_416.npy',trainDataArray_Output)
np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_testDataInput_416.npy',testDataArray_Input)
np.save('../seq2seq_ecg_codes/PredictionTask/inputData/sel102_testDataOutput_416.npy',testDataArray_Output)
