...
first_level_batch_size = resample_original_signals.shape[0] # number of sequences
...
with tf.variable_scope('Seq2seq'):
    ...
    '''
    Too many changes from version 0.12.1 ro present version
    '''
...
save_path = os.path.join(save_dir, 'LEVEL1_ECG_SeqLength_624_hidden_35')
