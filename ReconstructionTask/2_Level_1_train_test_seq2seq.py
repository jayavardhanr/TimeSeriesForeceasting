...
resample_original_signals = np.load('inputData/sel102_trainData_624.npy')
...
np.save('outputs/Train_Test_Encoder_State_LEVEL1_ECG_SeqLength_624_hidden_35.npy',en_state)
np.save('outputs/Train_Test_Prediction_LEVEL1_ECG_SeqLength_624_hidden_35.npy',pred_outputs)
np.save('outputs/Train_Test_TrueY_LEVEL1_ECG_SeqLength_624_hidden_35.npy',Y_test)
