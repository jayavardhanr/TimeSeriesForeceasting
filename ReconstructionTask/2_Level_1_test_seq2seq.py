...
resample_original_signals = np.load('inputData/sel102_testData_624.npy')
...
saved_path = os.path.join('checkpoints_seq2seq/', 'LEVEL1_ECG_SeqLength_624_hidden_35')
...
'''
#np.save('TEST_LEVEL1_GRU_Adam_prediction_1L_20u_non_overlap_TrainLoopTestLoop_without_input_4100EP.npy',pred_outputs)
np.save('_TEST_LEVEL1_GRU_Adam_enc_state_reverse_1L_20u_non_overlap_TrainLoopTestLoop_without_input.npy',en_state)
...
np.save('_TEST_LEVEL1_GRU_Adam_prediction_reverse_1L_20u_non_overlap_TrainLoopTestLoop_without_input.npy',pred_outputs)
#np.save('TEST_LEVEL1_GRU_true_1L_50u_007lr_non_overlap_TrainLoopTestLoop_EP.npy',X_test)
np.save('_TEST_LEVEL1_GRU_Adan_Y_true_reverse_1L_20u_non_overlap_TrainLoopTestLoop_without_input.npy',Y_test)
'''

np.save('outputs/Test_Test_Encoder_State_LEVEL1_ECG_SeqLength_624_hidden_35.npy',en_state)
np.save('outputs/Test_Test_Prediction_LEVEL1_ECG_SeqLength_624_hidden_35.npy',pred_outputs)
np.save('outputs/Test_Test_TrueY_LEVEL1_ECG_SeqLength_624_hidden_35.npy',Y_test)
